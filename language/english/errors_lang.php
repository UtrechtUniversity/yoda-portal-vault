...
$lang['ERROR_NO_INTAKE_ACCESS'] = "<p>You currently do not have intake access to any projects. Ask the owner of the study you need access to, to add you through the group manager.";
...
$lang['header:files_not_in_dataset'] = "<p>The following files reside in the root of the study. Only files inside a directory are classified as part of a dataset.</p><p>The files will not be deleted, but must be moved to a dataset before they can be backed up.</p>";
