                            ...
                            <?php foreach ($form->getSections() as $k => $name) { ?>
                                <fieldset>
                                    ...
                                    <div class="form-group combination-start">
                                        <div class="col-sm-4 col-sm-offset-3 no-padding"><label>First name</label><input type="text" class="form-control" name="person[0][Properties][name][0][first]"></div>
                                        <div class="col-sm-4">
                                            <label>Last name</label><input type="text" class="form-control" name="Related_Datapackage[0][Properties][name][0][last]"></div>
